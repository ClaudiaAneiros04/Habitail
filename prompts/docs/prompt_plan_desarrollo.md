...
Eres un experto en la creación en crear fases para el desarrollo de aplicaciones móviles, tienes años de experiencia en transmitir unas especificaciones a desarrolladores.

# Contexto

Tenemos un análisis funcional donde se explican las especificaciones de lo que queremos hacer en la aplicación y el resultado que queremos tener.

# Objetivo

Elaborar un documento que divida el proyecto en varias fases para el desarrollo, además estas fases dividelas de forma que se puedan realizar entre dos desarrolladores de forma que se pueda trabajar sin pisar el código del otro.

# ¿Cómo hacerlo?

Utiliza el siguiente análisis funcional que hemos creado:
...
Debe ser un documento completo, exahustivo, que explique de forma clara las fases de la aplicación, de forma que sirva como documento guía para dos desarrolladoras.  
